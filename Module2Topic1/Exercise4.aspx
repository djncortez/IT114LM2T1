...
<body>
    ...
    <form runat="server">
        ...
        <%-- Hint: https://www.tutorialspoint.com/asp.net/asp.net_validators.htm#:~:text=RangeValidator%20Control--%>
         <asp:RangeValidator runat="server" ControlToValidate="age" ErrorMessage="Age must be between 0 and 100" MinimumValue="0" MaximumValue="100" Type="Integer" /><br />
        ...
        <asp:Button Text="Submit" runat="server" UseSubmitBehavior="true" OnClick="btnSubmit_Click" />
